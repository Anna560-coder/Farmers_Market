...
import 'package:farmers_1/Views/Role_based_login/User/User%20Activity/Add%20to%20Cart/Widgets/cart_items.dart';
        ...
        children: [
          ...
          Row(
            children: [
              ...
              const SizedBox(width: 10),
              Text(
                "\R${(cp.totalCart()).toStringAsFixed(2)}",
          ...
          MaterialButton(
            ...
            child: Text(
              "Pay \R${((cp.totalCart() + 4.99).toStringAsFixed(2))}",
              style: const TextStyle(
                fontSize: 20,
                fontWeight: FontWeight.bold,
                color: Colors.white,
              ...
              content: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      "Total Payable Price: \R${(cp.totalCart() + 4.99).toStringAsFixed(2)}",
                    ),

...
List<AppModel> fashionEcommerceApp = [
  ...
  AppModel(
    ...
    isCheck: false,
    category: "Men",
    fcolor: [Colors.blue, Colors.red, Colors.purple],
    size: ["X", "XX", "XL"],
  ),
  // id:4
  AppModel(
    ...
    category: "Men",
    isCheck: false,
    fcolor: [Colors.brown, Colors.blueGrey, Colors.orange],
    size: ["S", "X"],
  ),
  // id:5
  AppModel(
    ...
    category: "Men",
    isCheck: false,
    fcolor: [Colors.black, Colors.orange, Colors.blueAccent],
    size: ["S", "XX", "X", "XL"],
  ),
  // id:6
  AppModel(
  ...
  AppModel(
    ...
    category: "Baby",
    isCheck: true,
    fcolor: [Colors.red, Colors.purple, Colors.pinkAccent],
    size: ["S", "B"],
  ),
  // id:8
  AppModel(
    ...
    category: "Men",
    isCheck: true,
    fcolor: [Colors.black, Colors.grey, Colors.white10],
    size: ["S", "XX", "X", "XL"],
  ),
  // id:9
  AppModel(
  ...
  AppModel(
    ...
    category: "Kids",
    isCheck: true,
    fcolor: [Colors.pink, Colors.blue, Colors.purple],
    size: ["S", "B", "X"],
  ),
  // id:11
  AppModel(
    ...
    category: "Teen",
    isCheck: true,
    fcolor: [Colors.pink, Colors.pinkAccent, Colors.orange],
    size: ["S", "B", "x"],
  ),
  // id:13
  AppModel(
    ...
    category: "Men",
    isCheck: true,
    fcolor: [Colors.green, Colors.blue, Colors.black],
    size: [
      "S",
      "X"
          "XL",
  ...
  AppModel(
    ...
    category: "Teens",
    isCheck: true,
    fcolor: [Colors.amber, Colors.black, Colors.amberAccent],
    size: [
      "S",
      "B"
          "X",
  ...
  AppModel(
    ...
    category: "Baby",
    isCheck: true,
    fcolor: [Colors.amber, Colors.green, Colors.blue],
    size: ["S", "B"],
  ),
  // id:16
  AppModel(
    ...
    category: "Teens",
    isCheck: false,
    fcolor: [Colors.pink, Colors.green, Colors.blue],
    size: ["S", "X", "XL"],
  ),
  // id:17
  AppModel(
    ...
    category: "Women",
    isCheck: false,
    fcolor: [Colors.blueGrey, Colors.green, Colors.grey],
    size: ["S", "X", "XL"],
  ),
  // id:19
  AppModel(
  ...
  AppModel(
    ...
    category: "Kids",
    isCheck: true,
    fcolor: [Colors.blueGrey, Colors.blueAccent, Colors.black],
    size: ["S", "X", "SX"],
  ),
];

const myDescription1 =
    "Explore our wide range of agricultural products including ";
const myDescription2 =
    " .We bring quality, reliability, and freshness straight from trusted sources to support every step of your farming journey.";
